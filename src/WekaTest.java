...
public class WekaTest {
	...
	public static void main(String[] args) throws Exception {
		BufferedReader datafile = readDataFile("E:\\NTU\\kat\\CZ4032\\src\\dataset\\student_math_binary.arff");
		...
		//add filter
		for (int count = 0; count < data.numAttributes()-1; count++) {
			System.out.println("Count : " + (count+1));
			System.out.println("Removed attribute : " + data.attribute(count));
